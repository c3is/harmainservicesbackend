...
app.post("/webhook/whatsapp", async (req, res) => {
  ...
  try {
    ...
    else if (message?.button?.payload) text = message.button.payload;
    ...
    if (text === "YES") {
      ...
      // 🔥 ONLY THIS CONTROLS EVERYTHING (ATOMIC)
      ...
      // ✅ ONLY FIRST PROVIDER REACHES HERE
